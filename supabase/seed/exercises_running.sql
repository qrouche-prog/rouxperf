...
insert into public.exercises (name, category, muscle_group, equipment_required, contraindications, instructions) values
  ...
  ('Course en côte', 'cardio', 'legs', '{bodyweight}', '{knee,ankle}', 'Sprints ou efforts soutenus en montée, redescente en marche/trot pour la récupération. Le champ reps exprime le format ("8x20s côte").');
